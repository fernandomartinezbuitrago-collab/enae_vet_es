...
try:
    ...
    contexto_rag = "Ayuno sólido: 8-12h. Agua: hasta 1-2h antes."
...
prompt = ChatPromptTemplate.from_messages([
    ...
    1. AYUNO: Sólidos 8-12h antes. Agua permitida hasta 1-2h antes.
    2. EDAD: Si el animal tiene >6 años, la analítica es OBLIGATORIA.
    3. CELO: Gatas se pueden operar. Perras NO; esperar 2 meses tras el celo.
    4. ENTREGAS: Gatos (08:00-09:00, Lun-Vie). Perros (09:00-10:30, Lun-Jue).
